...
def main(reprocess,userFile = "CGM24.userSettings" , processingOnly = False, expertFile="CGM2_4-pyCGM2.settings",emgFile="emg.settings",vskFile=None,plotFlag=False, overwrittenMode=True):

    modelInfo={"Version":"cgm2.4"}
    ...
    if not reprocess:
        ...
        builder = pipelineProcedure.CGM24PipelineBuilder(userSettings)
    ...
    if not reprocess:
        pmf.exportAQMinfos(DATA_PATH_OUT,"CGM 2.4",jsonAnalyses = jsonAnalysisInstances)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--userFile', type=str, help='userSettings', default="CGM24.userSettings")
    parser.add_argument('--expertFile', type=str, help='Local expert settings',default="CGM2_4-pyCGM2.settings")
