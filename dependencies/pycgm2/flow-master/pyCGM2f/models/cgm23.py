...
def main(reprocess,userFile = "CGM23.userSettings" , processingOnly = False, expertFile="CGM2_3-pyCGM2.settings",emgFile="emg.settings",vskFile=None,plotFlag=False, overwrittenMode=True):

    modelInfo={"Version":"cgm2.3"}

    DATA_PATH = os.getcwd()+"\\"
    DATA_PATH_OUT = DATA_PATH+"Processing-CGM23\\"
    ...
    if not reprocess:
        pmf.exportAQMinfos(DATA_PATH_OUT,"CGM 2.3",jsonAnalyses = jsonAnalysisInstances)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--userFile', type=str, help='userSettings', default="CGM23.userSettings")
    parser.add_argument('--expertFile', type=str, help='Local expert settings',default="CGM2_3-pyCGM2.settings")
