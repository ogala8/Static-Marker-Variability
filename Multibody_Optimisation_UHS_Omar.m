...
% are 2 at the ankle, 1 at the knee and 3 at the hip):
% 'U': Universal (2 degrees of freedom) at ankle
% 'H': Hinge (1 degree of freedom) at knee
% 'S': Spherical (3 degrees of freedom) at hip
%
% REFERENCES
...
% June 2014
% Version with one choice of joint models: UHS
%
% Modified by Raphaël Dumas
% July 2016
...
function Segment = Multibody_Optimisation_UHS_Omar(Segment)
...
if isfield(test,'nM')
    ...
    % Knee hinge joint angles from neutral position
    ...
    while max(permute(sqrt(sum(F.^2)),[3,2,1])) > 10e-12 && step < 20
       ...
       % Assembly
        ...
        lambdakK = lambdakK + dX(53:57,1,:);
        lambdakH = lambdakH + dX(58:60,1,:);
        lambdar = lambdar + dX(61:84,1,:);
