...
% Set markerset
markerSet = {'RASI','RILC','RPSI','LPSI','LILC','LASI','S1',...
             'RGTR','RTHI','RKNE','RKNM',...
             'RFAX','RTTA','RTIB','RANK','RMED',...
             'RHEE','RTOE','RFMH','RSMH','RVMH',...
             'RHAL',...
             'LGTR','LTHI','LKNE','LKNM',...
             'LFAX','LTTA','LTIB','LANK','LMED',...
...
landmarkList = {'landmark','landmark','landmark','landmark','landmark','landmark','hybrid-landmark',...
                ...
                'landmark','landmark','technical','landmark','landmark',...
...
segmentList = {'Pelvis','Pelvis','Pelvis','Pelvis','Pelvis','Pelvis','Pelvis',...
               'RThigh','RThigh','RThigh','RThigh',...
               'RShank','RShank','RShank','RShank','RShank',...
               'RFoot','none','RFoot','RFoot','RFoot',... % Toe not present in several sessions
               'none',...
               'LThigh','LThigh','LThigh','LThigh',...
               'LShank','LShank','LShank','LShank','LShank',...
